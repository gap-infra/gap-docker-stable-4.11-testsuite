[![Build Status](https://travis-ci.org/gap-infra/gap-docker-stable-4.11-testsuite.svg?branch=master)](https://travis-ci.org/gap-infra/gap-docker-stable-4.11-testsuite)
